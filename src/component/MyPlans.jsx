  ...
  return (
    <div>
      ...
      <Dialog open={open} handler={handleOpen}>
        ...
        <DialogBody>
          Upcoming diet plans involve careful consideration of nutritional needs
          and goals. Whether aiming for weight loss, improved health, or
          performance enhancement, a well-balanced diet tailored to individual
          preferences and requirements is essential. Planning meals in advance,
          incorporating diverse food groups, and maintaining portion control are
          key strategies for success. Stay flexible and adaptable, making
          adjustments as needed to achieve sustainable results and overall
          well-being.
        </DialogBody>
        <DialogFooter>
          <Button
